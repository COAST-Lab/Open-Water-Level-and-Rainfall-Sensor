...
// //Rainfall Sensor
// DFRobot_RainfallSensor_UART* rainfallSensor = nullptr; // global
// float rainfall_mm = 0.0f;   // cumulative rainfall (mm)
// uint32_t rawCounts = 0;     // number of bucket tips
...
//   Serial1.begin(9600);     // UART for rainfall sensor

//     Log.info("Initializing Rainfall Sensor...");

//     // Construct the rainfall sensor object as a pointer
//     rainfallSensor = new DFRobot_RainfallSensor_UART((SerialPort*)&Serial1);

//     // Begin communication
//     // if (rainfallSensor->begin()) {
//     //     Log.info("Rainfall sensor initialized successfully!");
//     // } else {
//     //     Log.info("Rainfall sensor initialization failed!");
//     // }
...
//     snprintf(data, sizeof(data), "%li,%.5f,%.02f,%.02f, %.2f", //,%.5f,%.5f,%.5f,%.5f,%.5f,%.02f,%.02f",
...
//     rainfall_mm = rainfallSensor->getRainfall();  // cumulative rainfall since last read (mm)
...
//       .gpio(D2, FALLING) //leave MaxSonar and Rain Sensor on
//       //.gpio(RX, FALLING)
